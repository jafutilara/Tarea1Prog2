...
class Main {
    public static void main(String[] args) {
        ...
        Gerente gerente1 = new Gerente("Juan", "Perez", "Masculino", "809-555-5555", 100000, "Programación");
        empleados.add(gerente1);
        Gerente gerente2 = new Gerente("Paola", "Suarez", "Femenino", "809-666-6666", 150000, "Diseño");
        empleados.add(gerente2);
        Programador programador1 = new Programador("Diana", "Marie", "Femenino", "849-777-7777", 75000,
                new ArrayList<>(Arrays.asList(
                        "HTML", "CSS", "Javascript", "React", "Wordpress", "Bootsrap", "Jquery", "NodeJS", "PHP")));
        empleados
                .add(programador1);
        Disenador disenador1 = new Disenador("Michael", "Gonzalez", "Masculino", "829-333-3333", 35000, "UI/UX");
        empleados.add(disenador1);

        gerente1.delegarTarea(disenador1);
        gerente2.delegarTarea(disenador1);

        // System.out.println("Bienvenido al sistema de información de empleados de la
        // empresa RJ");
